...
@objc class AppDelegate: FlutterAppDelegate {
    ...
    override func application(
        ...
        // הגדרת ה-Method Channel
        let api = ChatApiImpl(database: database)
        ChatApiSetup.setUp(binaryMessenger: controller.binaryMessenger, api: api)
        callback = ChatCallback(binaryMessenger: controller.binaryMessenger)
