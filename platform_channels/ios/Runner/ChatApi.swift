...
class ChatApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: ChatApi?, messageChannelSuffix: String = "") {
    ...
    let getMessagesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.platform_channels.ChatApi.getMessages\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let sendMessageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.platform_channels.ChatApi.sendMessage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getContactsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.platform_channels.ChatApi.getContacts\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let saveMessageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.platform_channels.ChatApi.saveMessage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class ChatCallback: ChatCallbackProtocol {
  ...
  func onNewMessage(message messageArg: Message, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.platform_channels.ChatCallback.onNewMessage\(messageChannelSuffix)"
  ...
  func onMessageStatusChanged(messageId messageIdArg: String, status statusArg: String, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.platform_channels.ChatCallback.onMessageStatusChanged\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
